  ...
  app.controller('notesController', function($scope, $http){
    ...
    $scope.getNotes = function(){
            $scope.isNewList = true;
                  return $http.get("/notes", {}).then(
                  function(notes){
                          $scope.notesList = notes.data;
                           alert("---Getting Fresh List from Backend---")
                        }, function(error){
    ...
    $scope.viewNote = function(){
        ...
        var r = confirm("You are going to Save this note");
              if (r == true){
